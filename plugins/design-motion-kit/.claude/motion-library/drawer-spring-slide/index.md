...
Drawer Spring Slide is a GSAP pattern for drawer surfaces that stages a panel or overlay
with coordinated depth and stagger.

SaaS product sections, dashboard states, ecommerce conversion surfaces that need clearer
motion hierarchy across drawer surfaces.
