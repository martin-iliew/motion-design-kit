...
Image Sequence Scroll Scrub is a GSAP pattern for media surfaces that steps through
prepared frames so scroll behaves like a lightweight film strip.

portfolio storytelling, ecommerce conversion surfaces, creative showcase pages that need
clearer motion hierarchy across media surfaces.
