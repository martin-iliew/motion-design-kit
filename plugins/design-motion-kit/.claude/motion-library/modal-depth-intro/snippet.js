...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="modal-depth-intro"]').forEach((block) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="modal-depth-intro"], [data-motion="modal-depth-intro"] [data-motion-target]", { clearProps: "all" });
});
