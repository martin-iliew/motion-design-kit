...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  const root = document.querySelector('[data-motion="pinned-story-panels"]');
  if (!root) return;
  const items = gsap.utils.toArray('[data-motion="pinned-story-panels"] [data-motion-item]');
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="pinned-story-panels"], [data-motion="pinned-story-panels"] [data-motion-item]", { clearProps: "all" });
});
