...
Cursor Image Preview Trail is a GSAP pattern for image, media surfaces that uses cursor-
proximate previews to enrich browsing without a click.

portfolio storytelling, ecommerce conversion surfaces, creative showcase pages that need
clearer motion hierarchy across image, media surfaces.
