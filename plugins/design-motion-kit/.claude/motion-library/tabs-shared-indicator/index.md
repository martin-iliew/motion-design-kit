...
Tabs Shared Indicator is a GSAP pattern for tabs, menu surfaces that uses FLIP
continuity so active-state indicators glide instead of jump.

SaaS product sections, dashboard states, ecommerce conversion surfaces that need clearer
motion hierarchy across tabs, menu surfaces.
