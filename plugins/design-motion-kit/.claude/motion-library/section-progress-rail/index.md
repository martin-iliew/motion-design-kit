...
Section Progress Rail is a GSAP pattern for section, progress bar surfaces that builds
scoped progress feedback that grows with the reading path.

marketing launches, portfolio storytelling, creative showcase pages that need clearer
motion hierarchy across section, progress bar surfaces.
