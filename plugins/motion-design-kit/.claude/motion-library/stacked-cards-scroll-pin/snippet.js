...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  const root = document.querySelector('[data-motion="stacked-cards-scroll-pin"]');
  if (!root) return;
  const items = gsap.utils.toArray('[data-motion="stacked-cards-scroll-pin"] [data-motion-item]');
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="stacked-cards-scroll-pin"], [data-motion="stacked-cards-scroll-pin"] [data-motion-item]", { clearProps: "all" });
});
