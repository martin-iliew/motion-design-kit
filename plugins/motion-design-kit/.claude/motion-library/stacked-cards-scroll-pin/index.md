...
Stacked Cards Scroll Pin is a GSAP pattern for timeline, section surfaces that pins a
sequence and hands focus from one beat to the next as the user scrolls.

marketing launches, portfolio storytelling, creative showcase pages that need clearer
motion hierarchy across timeline, section surfaces.
