...
Toast Stack Dismiss is a GSAP pattern for toast surfaces that keeps stacked
notifications organized through entry and dismissal motion.

SaaS product sections, dashboard states, ecommerce conversion surfaces that need clearer
motion hierarchy across toast surfaces.
