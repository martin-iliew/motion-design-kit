...
SplitText Char Rotation Burst is a GSAP pattern for text surfaces that animates
characters with dimensional rotation before settling into readable copy.
