...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="text-highlight-sweep"]').forEach((block) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="text-highlight-sweep"], [data-motion="text-highlight-sweep"] [data-motion-target]", { clearProps: "all" });
});
