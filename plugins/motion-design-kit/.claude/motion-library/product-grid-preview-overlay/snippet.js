...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="product-grid-preview-overlay"]').forEach((block) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="product-grid-preview-overlay"], [data-motion="product-grid-preview-overlay"] [data-motion-target]", { clearProps: "all" });
});
