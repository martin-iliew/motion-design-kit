...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="hamburger-icon-morph"]').forEach((button) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="hamburger-icon-morph"], [data-motion="hamburger-icon-morph"] [data-motion-line]", { clearProps: "all" });
});
