...
Accordion Scale Reveal is a GSAP pattern for accordion surfaces that reveals disclosure
content without the hard jump of instant height changes.

SaaS product sections, dashboard states, ecommerce conversion surfaces that need clearer
motion hierarchy across accordion surfaces.
