...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="svg-clip-mask-text-reveal"]').forEach((block) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="svg-clip-mask-text-reveal"], [data-motion="svg-clip-mask-text-reveal"] [data-motion-target]", { clearProps: "all" });
});
