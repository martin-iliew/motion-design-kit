...
Horizontal Loop Carousel is a GSAP pattern for carousel, gallery surfaces that creates a
seamless loop for horizontally repeated content.

portfolio storytelling, ecommerce conversion surfaces, creative showcase pages that need
clearer motion hierarchy across carousel, gallery surfaces.
