...
DrawSVG Route Reveal is a GSAP pattern for svg surfaces that draws a path or underline
progressively to guide the eye.

creative showcase pages, marketing launches, portfolio storytelling that need clearer
motion hierarchy across svg surfaces.
