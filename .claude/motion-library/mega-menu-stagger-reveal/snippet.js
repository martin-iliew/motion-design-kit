...
mm.add("(prefers-reduced-motion: no-preference)", () => {
  document.querySelectorAll('[data-motion="mega-menu-stagger-reveal"]').forEach((block) => {
...
mm.add("(prefers-reduced-motion: reduce)", () => {
  gsap.set("[data-motion="mega-menu-stagger-reveal"], [data-motion="mega-menu-stagger-reveal"] [data-motion-target]", { clearProps: "all" });
});
